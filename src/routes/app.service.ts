...
export class AppService {
    ...
    public findRandom() {
        ...
        return this.delayData(charactersAndQuotes[Math.floor(Math.random() * charactersAndQuotes.length)], this.randomIntForDelay());
    }
    ...
    private randomIntForDelay(min: number = 0, max: number = 1000) {
